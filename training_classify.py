...
"""
For training run:
python3 training_classify.py --task train --epochs 20 --batch_size 32 --model_path ./models/digit_classifier_svhn.pth

For using run: 
python3 training_classify.py --task classify --image_path ./S5.jpg --model_path ./models/digit_classifier_svhn.pth
"""
