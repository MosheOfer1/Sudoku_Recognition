...
def load_svhn_dataset(batch_size=32):
    transform = transforms.Compose([
        ...
        transforms.RandomRotation(5),  # Increased rotation
...
if __name__ == "__main__":
    ...
    trainloader, testloader = load_svhn_dataset(batch_size=64)  # Increased batch size
    model = DigitClassifier().to(device)
    train_model(model, trainloader, testloader, device, epochs=30, learning_rate=0.001, patience=10)
